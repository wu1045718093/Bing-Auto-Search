...
axios_bing.get('/', {
    ...
    .then(function (response) {
        if (response.status == 200) {
            let regex = /(<span id="id_n" title=").*?(")/;
            username_temp = regex.exec(response.data);
            if (username_temp) {
